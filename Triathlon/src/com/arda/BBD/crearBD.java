...
public class crearBD extends SQLiteOpenHelper{
	...
	//Parametros de tabla tiposcomp
		...
		public String sql1="CREATE TABLE Users (IDUSER     VARCHAR PRIMARY KEY NOT NULL,CONTRA     VARCHAR NOT NULL,NOMBRE     VARCHAR NOT NULL,FECHA      DATE NOT NULL,ENTRENADOR BOOLEAN,DEPORTISTA BOOLEAN NOT NULL,SEXO       BOOLEAN NOT NULL,FOTO       VARCHAR,FECHABAJA  DATETIME );";
		...
		public String sql7="INSERT INTO TIPOSCOMP (IDCOM,DISNAT,DISCAR,DISCI)VALUES('IRON','3'8',null,null);";
		public String sql8="INSERT INTO TIPOSCOMP (IDCOM,DISNAT,DISCAR,DISCI)VALUES('IRON',null,'180',null);";
		public String sql9="INSERT INTO TIPOSCOMP (IDCOM,DISNAT,DISCAR,DISCI)VALUES('IRON',null,null,'42'195');";
		public String sql10="INSERT INTO TIPOSCOMP (IDCOM,DISNAT,DISCAR,DISCI)VALUES('OLIM','1'5',null,null);";
		public String sql11="INSERT INTO TIPOSCOMP (IDCOM,DISNAT,DISCAR,DISCI)VALUES('OLIM',null,'40',null);";
		public String sql12="INSERT INTO TIPOSCOMP (IDCOM,DISNAT,DISCAR,DISCI)VALUES('OLIM',null,null,'10');";
