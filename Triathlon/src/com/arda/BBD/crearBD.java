...
public class crearBD extends SQLiteOpenHelper{
	...
	//Parametros de tabla tiposcomp
		...
		public String sql1="CREATE TABLE Users (IDUSER     VARCHAR PRIMARY KEY,CONTRA     VARCHAR,NOMBRE     VARCHAR,FECHA      DATE,ENTRENADOR BOOLEAN,DEPORTISTA BOOLEAN,SEXO       BOOLEAN,FOTO       VARCHAR,FECHABAJA  DATETIME );";
